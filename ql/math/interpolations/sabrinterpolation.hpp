...
class SABRInterpolation : public Interpolation {
  public:
    ...
    SABRInterpolation(const I1 &xBegin, // x = strikes
                      ...
                      const VolatilityType volatilityType = VolatilityType::Normal) { // Tony Yu: 3/19/2024 change the default vol type to normal vol

        QL_REQUIRE(volatilityType == VolatilityType::Normal, "Currently only accepting VolType = Normal!");
