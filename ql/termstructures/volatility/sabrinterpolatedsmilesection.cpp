...
namespace QuantLib {
    ...
    : //SmileSection(optionDate, dc, Date(), ShiftedLognormal, shift),
      SmileSection(optionDate, dc, Date(), Normal, shift), // 3/6/2024: Tony Yu, change the default volType to be normal
      ...
      evaluationDate_(Settings::instance().evaluationDate()) {
        ...
        // Tony: for testing print out some inputs
        //std::cout << "option date : " << optionDate << std::endl;
        //std::cout << "forward : " << forward << std::endl;
        //std::cout << "atmVolatility : " << atmVolatility << std::endl;
    ...
    void SabrInterpolatedSmileSection::createInterpolation() const {
         ext::shared_ptr<SABRInterpolation> tmp(new SABRInterpolation(
                     ...
                     endCriteria_, method_, 1e-10 /*ErrorAccept*/, false, 50, shift(), this->volatilityType()));
                     //endCriteria_, method_, 0.0020, false, 50, shift(), this->volatilityType()));
